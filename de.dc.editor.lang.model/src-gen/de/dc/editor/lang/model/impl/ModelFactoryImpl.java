...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ModelPackage.LANGUAGE_DEFINITION: return createLanguageDefinition();
			case ModelPackage.CONTENT_PROPOSAL: return createContentProposal();
			case ModelPackage.TOKEN: return createToken();
			case ModelPackage.FUNCTION: return createFunction();
			case ModelPackage.TEMPLATE: return createTemplate();
			case ModelPackage.KEYWORD_GROUP: return createKeywordGroup();
			case ModelPackage.KEY: return createKey();
	 ...
	 * @generated
	 */
	public ContentProposal createContentProposal() {
		ContentProposalImpl contentProposal = new ContentProposalImpl();
