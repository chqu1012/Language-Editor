/**
 */
package de.dc.editor.lang.model.util;

import de.dc.editor.lang.model.*;
...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.LANGUAGE_DEFINITION: {
				LanguageDefinition languageDefinition = (LanguageDefinition)theEObject;
				T result = caseLanguageDefinition(languageDefinition);
				if (result == null) result = caseNamedElement(languageDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.CONTENT_PROPOSAL: {
				ContentProposal contentProposal = (ContentProposal)theEObject;
				T result = caseContentProposal(contentProposal);
				if (result == null) result = caseNamedElement(contentProposal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModelPackage.TOKEN: {
				...
				if (result == null) result = caseContent(token);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Content Proposal</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Content Proposal</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseContentProposal(ContentProposal object) {
		return null;
	}
