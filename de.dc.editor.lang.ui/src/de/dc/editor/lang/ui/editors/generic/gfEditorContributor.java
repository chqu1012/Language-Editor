...
public class gfEditorContributor 
...
//		new Action(GfePlugin.getResourceString("_UI_ShowPropertiesView_menu_item")) {
//			public void run() {
//				try {
...
//					System.out.println("cant show property view");
//				}
//			}
//		};
...
//		new Action(GfePlugin.getResourceString("_UI_RefreshViewer_menu_item")) {
...
//		};
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager("_UI_Editor_menu", "org.eclipse.example.libraryMenuID");
		...
		//
		createChildMenuManager = new MenuManager(("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager("_UI_CreateSibling_menu_item");
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("additions", submenuManager);

		submenuManager = new MenuManager(("_UI_CreateSibling_menu_item"));
